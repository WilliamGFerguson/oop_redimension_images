...
Bien que le code soit relativement simple et corresponde à mes débuts en programmation, il démontre clairement mes compétences en programmation orientée objet et ma capacité à structurer un projet avec un flow logique de traitement des données.
